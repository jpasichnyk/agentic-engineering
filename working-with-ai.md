...
Agentic work feels cheap to the individual in a way that distorts judgment. The company pays a real bill — SaaS plans, API spend, seats — but at the moment you decide "let me try this thing," that cost is invisible to you and lands as a line item someone else reviews later. What is visible to you — your time and attention, and the attention you're pulling away from committed work — is easier to undercount because it doesn't show up anywhere until the committed work slips.

In a team with shared priorities and real deliverables, unplanned AI exploration is still unplanned work — and AI work is especially good at hiding how much of it you're signing up for. What started as "I'll just take a look for a couple of hours" becomes a couple of days, and then a couple of weeks, because the next promising lead always seems an hour away. Spend two weeks on an AI-driven refactor that isn't on the roadmap and the items that needed that time didn't get it. The AI didn't make those weeks free. It made them feel free. Initially.
